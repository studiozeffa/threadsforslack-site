        ...
        <div class="body-wrap">
          ...
          <main class="site-content">
              ...
              <div class="container-sm">
                <div class="hero-inner section-inner pb-0">
                  ...
                  >
                    <a
                      class="modal-trigger"
                      aria-controls="modal-03"
                      data-video="https://player.vimeo.com/video/174002812"
                      data-video-tag="iframe"
                      href="#"
                    >
                      <img
                        class="has-shadow"
                  ...
                  <div id="modal-03" class="modal modal-video">
              ...
              <div class="container">
                <div class="team-inner section-inner">
                  <div class="section-header center-content reveal-from-bottom">
                    <div class="container-xs">
                      <h2 class="mt-0 mb-16">
                        Our story - Lorem ipsum is placeholder text.
                      </h2>
                      <p class="m-0">
                ...
                <div class="section-inner has-top-divider">
                  <div class="container-xs">
                    ...
                    <div class="center-content">
                      <a
                        class="button button-secondary modal-trigger"
                      ...
                      <div class="modal-inner">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="center-content mt-24">
                            <a
                              class="button-link text-xxs tt-u modal-close-trigger"
                              aria-label="close"
                              href="#0"
                              >No thanks!</a
                            >
                    ...
                    <ul class="accordion list-reset mb-0">
                      <li class="is-active">
                        <div class="accordion-header text-sm">
                          <span class="text-sm text-color-high fw-500"
            ...
            <section class="roadmap section">
              <div class="container">
                <div class="roadmap-inner section-inner has-top-divider">
                  <div class="section-header center-content">
                    <div class="container-xs">
                    ...
                    <div class="timeline-wrap">
                      <div class="timeline-item">
                        <div class="timeline-item-inner">
                          ...
                          <div
                            class="timeline-item-content h4 m-0 reveal-from-side"
                          >
                            Deployed a high-quality first release and conducted a
              ...
              <div class="container">
                <div class="testimonial-inner section-inner has-top-divider">
                  <div class="section-header center-content">
                    <div class="container-xs">
                      <h2 class="m-0">
                        Testimonials -Lorem ipsum is placeholder text commonly used.
                      </h2>
                    </div>
                  </div>
                  <div class="tiles-wrap has-bg-color">
                    ...
                    >
                      <div class="tiles-item-inner has-shadow">
                        ...
                        <div
                          class="testimonial-item-footer text-xs fw-500 mt-32 mb-0 pt-24 has-top-divider"
                        >
                    ...
                    >
                      <div class="tiles-item-inner has-shadow">
                        ...
                        <div
                          class="testimonial-item-footer text-xs fw-500 mt-32 mb-0 pt-24 has-top-divider"
                        >
                          <span class="testimonial-item-name"> Diana Tarja </span>
                          <span> - </span>
                          <span class="testimonial-item-link">
                            <a href="#">AppName</a>
                          </span>
