			...
			<body class="is-preload">
				...
				<!-- Header -->
					<div id="header">
						...
						<h1>${adj} Threads for Slack</h1>
						<p>Slack threads are broken. Let's fix them together!</p>
				...
				<!-- Main -->
					<div id="main">
						...
						<header class="major container medium">
							<h2>Ut aliquet condimentum nibh
							<br />
							vel at sed cep convallis
							<br />
							augue vel accumsan</h2>
						...
						<footer class="major container medium">
							<h3>Mus ipsum orci cubilia</h3>
							<p>Vitae natoque dictum etiam semper magnis enim feugiat amet curabitur tempor orci penatibus. Tellus erat mauris ipsum fermentum etiam vivamus.</p>
							<ul class="actions special">
								<li><a href="#" class="button">Enim sed arcu</a></li>
							</ul>
						</footer>
